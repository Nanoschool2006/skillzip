...
class Credentials {
	...
	public static function save_credentials( $secret_key, $publishable_key, $stripe_user_id, $test_secret_key, $test_publishable_key ) {
		...
		return $response ? $connection->ensure_endpoint( false ) : $response;
	}
	...
	public static function disconnect() {
		...
		delete_option( Hooks::STRIPE_VERSION_META );
		delete_option( Hooks::CUSTOMER_PORTAL );
		update_option( 'tva_stripe_auto_display_buy_button', false );
	}
}
