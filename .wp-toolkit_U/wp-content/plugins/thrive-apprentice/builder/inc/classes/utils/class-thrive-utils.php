...
class Thrive_Utils {
	...
	/**
	 * Check REST API permissions for Thrive Theme endpoints
	 * 
	 * Centralized permission checking for Thrive Theme REST API endpoints
	 ...
	 */
	public static function check_rest_api_permissions( $request = null ) {
		// First check if the user has admin capabilities.
		if ( current_user_can( 'manage_options' ) ) {
			return true;
		}
		
		// Then check if the user has Thrive Theme access.
		if ( class_exists( 'Thrive_Theme_Product' ) && method_exists( 'Thrive_Theme_Product', 'has_access' ) ) {
