 ...
 */
add_filter( 'list_terms_exclusions', 'thrive_apprentice_list_terms_exclusions', 0, 4 );
function thrive_apprentice_list_terms_exclusions( $exclusions, $args, $taxonomies ) {
	/**
