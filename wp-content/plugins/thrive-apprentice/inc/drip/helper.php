...
/*
 * NOTE (#3616 / #4431): the one-time injection of [tva_drip_unlock_date] into
 * existing locked TARs lives in
 * database/migrations/drip-unlock-date-tar-reseed-1.0.18.php (previously an
 * init-hook option-flag migration here). The injected markup there must stay
 * byte-identical to the seed in templates/access-restriction/locked/template.php.
 */
