...
class Video_Completed extends Event {
	...
	public static function label(): string {
		return esc_html__( 'Video completed', 'thrive-apprentice' );
	}
	...
	public function get_event_description(): string {
		...
		return sprintf( esc_html__( ' completed video "%s" from lesson "%s", course "%s"', 'thrive-apprentice' ), $video, $lesson, $course );
	}
}
