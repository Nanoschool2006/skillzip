...
<tr class="form-field">
	...
	<td>
		<select name="<?php echo Thrive_Category::PAGE_REDIRECT; ?>">
			...
			<?php foreach ( get_redirect_page_ids() as $page_id ): ?>
				<option value="<?php echo $page_id; ?>" <?php echo ( $page_id === (int) $landing_page_id ) ? 'selected' : ''; ?>><?php echo get_the_title( $page_id ); ?></option>
			<?php endforeach; ?>
		</select>
