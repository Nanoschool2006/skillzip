...
class TVE_Ult_Const {
	 ...
	 * TU plugin version
	 */
	const PLUGIN_VERSION = '10.8.10.2';
	...
	const TRIGGER_TYPE_WEBHOOK          = 'webhook';
	...
	const FIELD_DISPLAY_POSITION = 'display_position';
	...
	const COOKIE_REDIRECT      = 'tu_campaign_redirect_';
	...
	public static function campaign_types_details() {
		return array(
			static::CAMPAIGN_TYPE_ABSOLUTE  => array(
				'name'    => __( 'Fixed Dates Campaign', 'thrive-ult' ),
				'image'   => 'tvd-absolute-campaign.png',
				'tooltip' => __( 'Use this campaign type for an offer with predefined start and end dates. For instance, an offer available between the 5th and 12th of November.', 'thrive-ult' ),
			),
			static::CAMPAIGN_TYPE_ROLLING   => array(
				'name'    => __( 'Recurring Campaign', 'thrive-ult' ),
				'image'   => 'tvd-rolling-campaign.png',
				'tooltip' => __( 'Use this campaign type for an offer with a definite repetition cycle. For instance, an offer that starts on November 5th and is repeated monthly.', 'thrive-ult' ),
			),
			static::CAMPAIGN_TYPE_EVERGREEN => array(
				'name'    => __( 'Evergreen Campaign', 'thrive-ult' ),
				'image'   => 'tvd-evergreen-campaign.png',
				'tooltip' => __( 'Use this campaign type for offers triggered by user actions, not by dates. For instance, an offer showing for 7 days after a new user subscribes to a newsletter', 'thrive-ult' ),
			),
		);
	}
	...
	public static function design_types_details() {
		return array(
			static::DESIGN_TYPE_HEADER_BAR => array(
				'name'          => __( 'Top ribbon', 'thrive-ult' ),
				'description'   => __( 'shows at the top of the screen', 'thrive-ult' ),
				'image'         => 'tvu-header-bar-design.png',
				'edit_selector' => '.thrv_ult_bar',
			),
			static::DESIGN_TYPE_FOOTER_BAR => array(
				'name'          => __( 'Bottom ribbon', 'thrive-ult' ),
				'description'   => __( 'shows at the bottom of the screen', 'thrive-ult' ),
				'image'         => 'tvu-footer-bar-design.png',
				'edit_selector' => '.thrv_ult_bar',
			),
			static::DESIGN_TYPE_WIDGET     => array(
				'name'          => __( 'Widget', 'thrive-ult' ),
				'description'   => __( 'displays in any widget area on your site', 'thrive-ult' ),
				'image'         => 'tvu-widget-design.png',
				'edit_selector' => '.thrv_ult_widget',
			),
			static::DESIGN_TYPE_SHORTCODE  => array(
				'name'          => __( 'Shortcode', 'thrive-ult' ),
				'description'   => __( 'display shortcode design in your content', 'thrive-ult' ),
		...
		return array(
			...
			'1' => array(
				...
				'settings'     => array(
					...
					'repeatOn' => array(),
					'trigger'  => array(
						'type' => static::TRIGGER_TYPE_FIRST_VISIT,
						'ids'  => '',
					),
				),
				'designs'      => array(
					'design_0' => array(
						'post_type'   => static::DESIGN_TYPE_HEADER_BAR,
			...
			'2' => array(
				'id'           => '2',
				'name'         => __( 'Christmas special', 'thrive-ult' ),
				'description'  => __( 'Triggered to start and end on specific dates. When the offer has 2 days left, the state is changed to reflect the small amount of time before the offer expires.', 'thrive-ult' ),
				'image'        => static::plugin_url( 'admin/img/tvu-campaign-template3.png' ),
				'type'         => static::CAMPAIGN_TYPE_ABSOLUTE,
				'rolling_type' => '',
				'status'       => static::CAMPAIGN_STATUS_PAUSED,
				'settings'     => array(
					'start'    => array(
			...
			'3' => array(
				'id'           => '3',
				'name'         => __( 'End of month specials', 'thrive-ult' ),
				'description'  => __( 'Triggered to start on a certain day of the month and to last for 2 days.', 'thrive-ult' ),
				'image'        => static::plugin_url( 'admin/img/tvu-campaign-template4.png' ),
				'type'         => static::CAMPAIGN_TYPE_ROLLING,
				'rolling_type' => static::CAMPAIGN_ROLLING_TYPE_MONTHLY,
				'status'       => static::CAMPAIGN_STATUS_PAUSED,
				'settings'     => array(
					'start'    => array(
						'date' => tve_ult_current_time( 'j F Y' ),
