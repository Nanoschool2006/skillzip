...
$string['signuptextcolor'] = 'Signup description color';
$string['signuptextcolordesc'] = 'Select the text color for Signup page description.';
...
$string['showimporter'] = 'Show Importer';
$string['showimporterdesc'] = 'Show Importer icon in left sidebar footer.';
