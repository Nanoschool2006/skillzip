...
class Lesson_Complete extends Event {
	...
	public static function get_tooltip_text(): string {
		return '<strong>{number}</strong> ' . esc_html__( 'completed lessons', 'thrive-apprentice' );
	}
	...
	public static function label(): string {
		return esc_html__( 'Lesson Completed', 'thrive-apprentice' );
	}
	...
	public function get_event_description(): string {
		...
		return sprintf( esc_html__( ' completed lesson "%s" in the course "%s"', 'thrive-apprentice' ), $lesson, $course );
	}
