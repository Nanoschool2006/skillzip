...
class Drip_Unlocked_For_User extends Event {
	...
	public static function label(): string {
		return esc_html__( 'Drip unlocked for user', 'thrive-apprentice' );
	}
	...
	public function get_event_description() {
		...
		return sprintf( esc_html__( ' unlocked %s "%s" in the course "%s".', 'thrive-apprentice' ), $type, $item, $course_title );
	}
}
