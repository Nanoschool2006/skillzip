...
class FrmPdfsAppHelper {
	 ...
	 * @var string
	 */
	public static $plug_version = '2.0.7';
...
HTML;
	...
	public static function get_pagination_total_pages_placeholder() {
		// Don't use a long string, it will take space even after replaced with the actual number.
		return '^^';
	}
	...
	public static function dompdf_should_encode_uri( $uri ) {
		...
		if ( str_starts_with( $uri, 'https://api.qrserver.com/v1/create-qr-code/?' ) ) {
			$should_encode = false;
		}
