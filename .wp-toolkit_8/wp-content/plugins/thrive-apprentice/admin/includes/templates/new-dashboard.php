...
<div class="td-app-notification-drawer">
    <div class="td-app-notification-holder">
        <div class="td-app-notification-header notification-header-notify-ta"></div>
        <div class="td-app-notification-wrapper notification-wrapper-notify-ta"></div>
        <div class="notification-footer notification-footer-notify-ta"></div>
    </div>
</div>
