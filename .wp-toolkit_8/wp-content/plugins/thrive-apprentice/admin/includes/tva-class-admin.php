...
class TVA_Admin {
	...
	public function enqueue_scripts( $screen_id ) {
		...
		if ( static::$can_run ) {
			 ...
			 * Enqueue Rubik font
			 */
			wp_enqueue_style( 'ta-font-rubik', '//fonts.bunny.net/css?family=Rubik:200,300,400,500,600,700,800' );
			...
			/**
			 * Include the TImepicker Script & Style
			 */
			wp_enqueue_script( 'thrive-apprentice-timepicker-script', $this->url( 'libs/jquery.timepicker.min.js' ), array( 'jquery' ), TVA_Const::PLUGIN_VERSION, true );
			// wp_enqueue_style( 'thrive-apprentice-timepicker-style', $this->url( 'libs/spectrum.css' ), array(), TVA_Const::PLUGIN_VERSION );
	...
	public function get_localize_data() {
		...
		return array(
			...
			'max_upload_size_raw'  => wp_max_upload_size() / MB_IN_BYTES,
