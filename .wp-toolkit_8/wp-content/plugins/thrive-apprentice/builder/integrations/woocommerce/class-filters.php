...
class Filters {
	...
	public static function add() {
		...
		add_filter( 'woocommerce_cart_item_class', [ __CLASS__, 'add_sold_individually_class_to_cart_items' ], 10, 3 );
	}
	...
	/**
	 * Add sold-individually class to cart items.
	 *
	 * @param string $class
	 * @param array $values
	 ...
	 * @return string
	 */
	public static function add_sold_individually_class_to_cart_items( $class, $values, $values_key ): string {
		if ( $values['data']->is_sold_individually() ) {
			$class .= ' sold-individually';
		}
