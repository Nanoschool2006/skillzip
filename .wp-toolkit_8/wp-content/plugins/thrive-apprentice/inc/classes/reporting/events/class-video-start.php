...
class Video_Start extends Event {
	use Report {
		Report::get_group_by as _get_group_by;
	}

	public static function key(): string {
		return 'tva_video_start';
	}

	public static function label(): string {
		return esc_html__( 'Video started', 'thrive-apprentice' );
	}
	...
	public static function register_action() {
		add_action( 'thrive_video_start', static function ( $data ) {
	...
	public function get_event_description(): string {
		...
		return sprintf( esc_html__( ' started video "%s" from lesson "%s", course "%s"', 'thrive-apprentice' ), $video, $lesson, $course );
	}
}
