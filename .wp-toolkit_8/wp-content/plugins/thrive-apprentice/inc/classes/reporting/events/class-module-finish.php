...
class Module_Finish extends Module_Start {
	...
	public static function label(): string {
		return esc_html__( 'Modules finished', 'thrive-apprentice' );
	}
	...
	public function get_event_description(): string {
		...
		return sprintf( esc_html__( ' finished module "%s" in the course "%s"', 'thrive-apprentice' ), esc_html( $item ), esc_html( $course ) );
	}
}
