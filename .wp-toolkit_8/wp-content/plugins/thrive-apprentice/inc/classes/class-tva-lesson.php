...
class TVA_Lesson extends TVA_Post {
	...
	public function duplicate( $post_parent = null, $name = '' ) {
		...
		/**
		 * Clone conditional display groups and other TCB-specific content.
		 * This ensures elements with conditional display are independent in the cloned lesson.
		 */
		do_action( 'after_thrive_clone_item', $new_lesson->ID, $this->ID, [] );
