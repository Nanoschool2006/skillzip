...
add_filter( 'architect.branding', 'tve_ult_architect_branding', 10, 2 );
 ...
 * @return string
 */
function tve_ult_architect_branding( $string, $type = 'logo_src' ) {
	if ( tve_ult_is_editable( get_post_type() ) ) {
		switch ( $type ) {
			case 'name':
				$string = 'Thrive Ultimatum';
				break;
			default:
				$string = TVE_Ult_Const::plugin_url( 'admin/img/logo_90x90.png' );
				break;
		}
	}
