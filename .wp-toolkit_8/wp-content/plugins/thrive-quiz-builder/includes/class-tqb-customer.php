...
class TQB_Customer {
	 ...
	 * @param int      $quiz_id
	 * @param int      $post_id
	 * @param int|null $limit Optional limit for number of recent answers to return (null = all answers)
	 *
	 * @return array|false|null
	 */
	public function get_resume_quiz_user_answers( $quiz_id, $post_id, $limit = null ) {
		$user_quiz_try = $this->get_last_user_try( $quiz_id, $post_id );
		$return        = [];

		if ( $user_quiz_try ) {
			$return = TQB_Quiz_Manager::get_user_answers_in_order( $quiz_id, $user_quiz_try['id'], $limit );
		}
