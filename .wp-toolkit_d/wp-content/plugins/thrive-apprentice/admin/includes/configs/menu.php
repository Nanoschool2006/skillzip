	...
	'settings'        => [
		...
		'items' => [
			...
			'payments' => [
				...
				'icon'  => 'dollar-sign',
				'label' => esc_html__( 'Payments', 'thrive-apprentice' ),
				'items' => [
					'stripe' => [
						'slug'  => 'stripe',
						'route' => '#settings/payments/stripe',
					...
					'square' => [
						...
						'label' => esc_html__( 'Square', 'thrive-apprentice' ),
					],
				],
			],
			'logs'                => [
			...
			'data-cleanup'        => [
				'slug'  => 'data-cleanup',
				'route' => '#settings/data-cleanup',
				'icon'  => 'data-cleanup',
				'label' => esc_html__( 'Data Cleanup', 'thrive-apprentice' ),
			],
	],
],
];
...
$tva_menu['notice'] = [
	...
	'route' => '#notice',
	'icon'  => 'icon-notice',
	'label' => esc_html__( 'Notice', 'thrive-apprentice' ),
	'items' => [],
];
