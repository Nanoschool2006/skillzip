...
class Certificate_Download extends Event {
	...
	public static function label(): string {
		return esc_html__( 'Certificate downloads', 'thrive-apprentice' );
	}
	...
	public static function register_action() {
		add_action( 'tva_certificate_downloaded', static function ( $certificate_data, $user_data, $course_data ) {
			$event = new self( [
	...
	public function get_event_description(): string {
		...
		return sprintf( esc_html__( ' downloaded course %s\'s certificate.', 'thrive-apprentice' ), $item );
	}
}
